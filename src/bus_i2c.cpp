...
size_t BusI2CDevice::readData(void* data, size_t size) {
    if (bus_.requestFrom(static_cast<uint8_t>(address_), size, true) != size) return 0;
    uint32_t i;
